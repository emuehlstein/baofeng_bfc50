...
class T18Radio(chirp_common.CloneModeRadio):
    ...
    def get_memory(self, number):
        ...
        mem.extra.append(rs)
        if self.MODEL != "RB18" and self.MODEL != "BF-C50" and self.MODEL != "RB618" and \
    ...
    def set_memory(self, mem):
        ...
        if self.MODEL != "T18" and self.MODEL != "RB18" and self.MODEL != "BF-C50":
    ...
    def get_settings(self):
        ...
        if self.MODEL == "RB18" or self.MODEL == "RB618" or self.MODEL == "BF-C50":
        ...
        if self.MODEL == "RT20":
            ...
            basic.append(rs)
        elif self.MODEL == "RB18" or self.MODEL == "RB618" or self.MODEL == "BF-C50":
...
class BFC50Radio(T18Radio):
    ...
    POWER_LEVELS = [chirp_common.PowerLevel("High", watts=5.00),
                    chirp_common.PowerLevel("Low",  watts=3.00)]
    ...
    def process_mmap(self):
        self._memobj = bitwise.parse(MEM_FORMAT_BFC50 %
                                     self._mem_params, self._mmap)
